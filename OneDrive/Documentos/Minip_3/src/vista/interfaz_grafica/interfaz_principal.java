...
public class interfaz_principal extends javax.swing.JFrame {
    ...
    public interfaz_principal() {
        ...
        // Inicialización del JComboBox para las misiones
        comboBoxMisiones = new javax.swing.JComboBox<>();
        comboBoxMisiones.setModel(new javax.swing.DefaultComboBoxModel<>(Misiones.values()));
    ...
    private void initComponents() {
        ...
        comboBoxMisiones = new javax.swing.JComboBox<>(Misiones.values());
        ...
        panel_mision_y_codigo.add(comboBoxMisiones);
    ...
    void buscar(ArrayList<Soldado> listaSoldados1){
        ...
        // Obtener la misión seleccionada del JComboBox
        Misiones mision = (Misiones) comboBoxMisiones.getSelectedItem(); // Esto obtiene la misión seleccionada
        if (idSoldado.isEmpty() || mision == null) {
            JOptionPane.showMessageDialog(this, "Por favor, ingrese un ID de soldado y seleccione una misión.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        for (Soldado i : listaSoldados1) {
            ...
            if (idDelSoldado.equals(idSoldado)) {
                // Aquí se asigna la misión al soldado
                JOptionPane.showMessageDialog(this, i.asignarMision(mision), "Misión asignada al militar buscado", JOptionPane.INFORMATION_MESSAGE);
            }
        }
    }
...
private void nimbusActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private javax.swing.JComboBox<Misiones> comboBoxMisiones;
